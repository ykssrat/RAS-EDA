...
EXTERN long         tf_getp PROTO_PARAMS((int pnum));
...
EXTERN long         tf_igetp PROTO_PARAMS((int pnum, char *inst));
...
EXTERN void         tf_sigsegv_counter_reset PROTO_PARAMS((void));
...
EXTERN void         mc_refresh_plusargs PROTO_PARAMS((void));
