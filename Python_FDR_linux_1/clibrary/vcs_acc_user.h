...
#define accGenerated              801
#define accAutomatic              802
#define accChandleVar             803
...
#ifndef VXL_VERIUSER_H /* to avoid redefinition in vxl_veriuser.h */
...
#define accClassVar             744
#define accStringMda            745
#define accClassMda             746
#define accClassDefn            747
#define accVcsPackage           748
#define accInterfacePort        749
#define accModportPort          750
#define accModport              751
#define accChandleMda           752
#define accShortRealMda         753
#define accVoid                 754

/* for wreal array */
#define accMdaRealWire          755

#define accInterconnect         756
...
extern void acc_lsi_dumpports_vhdl_enable VCS_ARGS ((int enable));
...
/*----------- additional values for vc_reason field in t_vc_record structure -----------*/
#define object_creation             12
#define object_deletion             13
#define frame_creation              14
#define frame_deletion              15
#define thread_creation             16
#define thread_deletion             17
#define thread_state_change         18

#define vpi_value_change            12 /* copied form other place. don't know why it's equal to object_creation*/
#define vpi_type_change             19

/*----------- values for thread states ------------*/
#define accCurrent                    1  /* currently executing */
#define accReady                      2  /* ready to execute at current time */
#define accBlocked                    3  /* blocked due to mailbox/semaphore/event */
#define accWaiting                    4  /* waiting for child(ren) to finish */

typedef struct ValStructF01X_ {
    int forced;
    int val0;
    int val1;
    int valx;
...
int vcs_net_contention(handle pnet, ValStructF01X* val);
void CountDriversCALL(void);
